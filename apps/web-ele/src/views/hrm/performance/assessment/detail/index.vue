...
<template>
  <Page auto-content-height>
    <div class="mb-5 flex items-center gap-3">
      <Button link @click="close">返回</Button>
    ...
    <ElTabs v-model="activeTab">
      <ElTabPane label="考核评分" name="score">
        <div
      ...
      <ElTabPane label="考核记录" name="record">
